...
const InvoiceForm: React.FC<Props> = ({ mode, initial, onSubmit, onCancel, error }) => {
  ...
  const calcLine = (item: InvoiceItemIn) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    const schema = mode === 'edit' ? invoiceUpdateSchema : invoiceCreateSchema
    const payload = {
      ...form,
